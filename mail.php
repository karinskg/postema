...
try {
  ...
  $mail->Username   = 'petrakarin12@yandex.by'; // Логин на почте
  $mail->Password   = 'lndpgrdjaywtipyf'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('petrakarin12@yandex.by', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('petrakarin12@yandex.by');
